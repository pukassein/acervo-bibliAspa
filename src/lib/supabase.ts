...
// These are public client settings. They do not replace Supabase Auth/RLS.
// Configure VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in production to avoid
// relying on the legacy fallback below.
